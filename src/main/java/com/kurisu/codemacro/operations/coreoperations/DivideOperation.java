...
public class DivideOperation implements CoreOperation {
    ...
    public Operand solve() throws InvalidOperandException, OperationException, InstructionException {
        ...
        if (val1 instanceof Integer && val2 instanceof Integer) {
            ...
            throw new InvalidOperandException("Cannot divide " + val1.getClass() + " between " + val2.getClass());
        }
    }
    ...
    private Operand getIntegerValue(final Object val1, final Object val2) throws InvalidOperandException {
        try {
            ...
            if(value2 == 0){
                throw new InvalidOperandException("Division between 0.");
            }
            return new IntegerOperand(value1 / value2);
        } catch (Exception e) {
            throw new InvalidOperandException("Cannot get integer value for division operation.");
        }
    }
    ...
    private Operand getDoubleValue(final Object val1, final Object val2) throws InvalidOperandException {
        try {
            ...
            throw new InvalidOperandException("Cannot get floating value for division operation.");
        }
    }
    ...
    private Operand getMixedValueIntFirst(final Object val1, final Object val2) throws InvalidOperandException {
        try {
            ...
            throw new InvalidOperandException("Cannot get floating|integer value for division operation.");
        }
    }
