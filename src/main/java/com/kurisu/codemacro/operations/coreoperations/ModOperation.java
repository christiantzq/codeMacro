...
public class ModOperation implements CoreOperation {
    private Operand op1;
    private Operand op2;

    public ModOperation(final Operand op1, final Operand op2) {
        this.op1 = op1;
        this.op2 = op2;
    }
    ...
    public Operand solve() throws InvalidOperationComponentException, OperationException, InstructionException {
        ...
        if (val1 instanceof Integer && val2 instanceof Integer) {
            ...
            throw new InvalidOperationComponentException("Cannot divide " + val1.getClass() + " by " + val2.getClass());
        }
    }
    ...
    private Operand getIntegerValue(final Object val1, final Object val2) throws InvalidOperationComponentException {
        try {
            ...
            if (value2 == 0) {
                throw new InvalidOperationComponentException("Division by 0.");
            }
            return new IntegerOperand(value1 % value2);
        } catch (Exception e) {
            throw new InvalidOperationComponentException("Cannot get integer value for mod operation.");
        }
    }
    ...
    private Operand getDoubleValue(final Object val1, final Object val2) throws InvalidOperationComponentException {
        try {
            ...
            return new IntegerOperand(mod.intValue());
        } catch (Exception e) {
            throw new InvalidOperationComponentException("Cannot get floating value for mod operation.");
        }
    }
    ...
    private Operand getMixedValueIntFirst(final Object val1, final Object val2)
        ...
        try {
            ...
            throw new InvalidOperationComponentException("Cannot get floating|integer value for mod operation.");
        }
    }
