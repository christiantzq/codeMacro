...
/**
 * Encapsulates a function call inside an Operation.
 * Calculates and returns the result of the function as an Operand.
 */
public class FunctionCallerComponent implements OperationComponent {
